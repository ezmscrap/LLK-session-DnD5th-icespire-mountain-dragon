...
|項目名|概要|実装|詳細|
|-----|-----|-----|-----|
|能力値変更装備対応|【筋力】を19にするなどの装備の効果を反映させる| 済み | 4/21 |
|イニシアチブ修正装備対応|イニシアチブ値を修正する装備の効果を反映させる| 済み | 4/21 |
|SS修正装備対応|セーヴィングスローを修正する装備の効果を反映させる| 済み | 4/21 | 
...
|項目名|概要|実装|詳細|
|-----|-----|-----|-----|
|SSの習熟Bが未反映|セーヴィーングスローに習熟ボーナスが入っていない場合がある| 済み | 4/21 |
|LvUpの能力値が未反映|レベルアップデータで変更した能力値が反映されていない| 済み | 4/21 |
|LvUpの習熟Bが未反映|レベルアップデータで変更した習熟ボーナスが反映されていない| 済み | 4/21 |
|命中に習熟Bが未反映|命中に習熟ボーナスが入っていない| 済み | 4/21 |
